...
{
	BinTreeNode<char> *p;
	char pre[]={'A','B','D','E','F','C','I'}; // 先序序列
	char in[]={'D','B','F','E','A','C','I'};  // 中序序列
//	char pre[100],in[100];
//	cout << "请输入先序序列：";
//	cin>>pre;
//	cout << "请输入中序序列：";
		...
		switch (c) 	{
		    ...
		    case '3':
	         ...
	         case 'a':
				...
				int a;
				a=bt.Depth();
				cout << "二叉树的最大宽度为：" << a << endl;
				break;
	         case 'b':
				cout << endl;
				cout << bt.LeafCount(bt.GetRoot()) << endl;
				break;
		}
	}
	return 0;
